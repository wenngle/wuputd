...
class TestSchemaAPIResponseSchemaSection(unittest.TestCase):
    """SchemaAPIResponseSchemaSection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SchemaAPIResponseSchemaSection:
        """Test SchemaAPIResponseSchemaSection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SchemaAPIResponseSchemaSection`
        """
        model = SchemaAPIResponseSchemaSection()
        if include_optional:
            return SchemaAPIResponseSchemaSection(
                data = openapi_client.models.schema/section.schema.Section(
                    _id = '', 
    ...
    def testSchemaAPIResponseSchemaSection(self):
        """Test SchemaAPIResponseSchemaSection"""
