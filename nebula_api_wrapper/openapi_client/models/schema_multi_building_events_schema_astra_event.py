...
class SchemaMultiBuildingEventsSchemaAstraEvent(BaseModel):
    """
    SchemaMultiBuildingEventsSchemaAstraEvent
    """ # noqa: E501
    buildings: Optional[List[SchemaSingleBuildingEventsSchemaAstraEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buildings": [SchemaSingleBuildingEventsSchemaAstraEvent.from_dict(_item) for _item in obj["buildings"]] if obj.get("buildings") is not None else None,
            "date": obj.get("date")
        })
        return _obj
