...
class SchemaRoomEventsSchemaAstraEvent(BaseModel):
    """
    SchemaRoomEventsSchemaAstraEvent
    """ # noqa: E501
    events: Optional[List[SchemaAstraEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [SchemaAstraEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "room": obj.get("room")
        })
        return _obj
