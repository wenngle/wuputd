...
class SchemaRoomEventsSchemaMazevoEvent(BaseModel):
    """
    SchemaRoomEventsSchemaMazevoEvent
    """ # noqa: E501
    events: Optional[List[SchemaMazevoEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [SchemaMazevoEvent.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "room": obj.get("room")
        })
        return _obj
