...
class SchemaAPIResponseSchemaMultiBuildingEventsSchemaSectionWithTime(BaseModel):
    """
    SchemaAPIResponseSchemaMultiBuildingEventsSchemaSectionWithTime
    """ # noqa: E501
    data: Optional[SchemaMultiBuildingEventsSchemaSectionWithTime] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaMultiBuildingEventsSchemaSectionWithTime.from_dict(obj["data"]) if obj.get("data") is not None else None,
