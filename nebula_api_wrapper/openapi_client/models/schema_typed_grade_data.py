...
class SchemaTypedGradeData(BaseModel):
    """
    SchemaTypedGradeData
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, alias="_id")
    data: Optional[List[SchemaTypedGradeDataDataInner]] = None
    __properties: ClassVar[List[str]] = ["_id", "data"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_id": obj.get("_id"),
            "data": [SchemaTypedGradeDataDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
