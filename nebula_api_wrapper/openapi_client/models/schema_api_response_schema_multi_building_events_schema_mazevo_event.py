...
class SchemaAPIResponseSchemaMultiBuildingEventsSchemaMazevoEvent(BaseModel):
    """
    SchemaAPIResponseSchemaMultiBuildingEventsSchemaMazevoEvent
    """ # noqa: E501
    data: Optional[SchemaMultiBuildingEventsSchemaMazevoEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaMultiBuildingEventsSchemaMazevoEvent.from_dict(obj["data"]) if obj.get("data") is not None else None,
