...
class SchemaObjectInfo(BaseModel):
    """
    SchemaObjectInfo
    """ # noqa: E501
    ...
    md5: Optional[List[StrictInt]] = None
    media_link: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    size: Optional[StrictInt] = None
    updated: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["bucket", "content_encoding", "content_type", "created", "md5", "media_link", "name", "size", "updated"]
