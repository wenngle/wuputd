...
class SchemaAPIResponseSchemaMultiBuildingEventsSchemaAstraEvent(BaseModel):
    """
    SchemaAPIResponseSchemaMultiBuildingEventsSchemaAstraEvent
    """ # noqa: E501
    data: Optional[SchemaMultiBuildingEventsSchemaAstraEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaMultiBuildingEventsSchemaAstraEvent.from_dict(obj["data"]) if obj.get("data") is not None else None,
