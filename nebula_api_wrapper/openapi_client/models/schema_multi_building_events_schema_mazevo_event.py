...
class SchemaMultiBuildingEventsSchemaMazevoEvent(BaseModel):
    """
    SchemaMultiBuildingEventsSchemaMazevoEvent
    """ # noqa: E501
    buildings: Optional[List[SchemaSingleBuildingEventsSchemaMazevoEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "buildings": [SchemaSingleBuildingEventsSchemaMazevoEvent.from_dict(_item) for _item in obj["buildings"]] if obj.get("buildings") is not None else None,
            "date": obj.get("date")
        })
        return _obj
