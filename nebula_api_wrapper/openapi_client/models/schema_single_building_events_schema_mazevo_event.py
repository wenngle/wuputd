...
class SchemaSingleBuildingEventsSchemaMazevoEvent(BaseModel):
    """
    SchemaSingleBuildingEventsSchemaMazevoEvent
    """ # noqa: E501
    building: Optional[StrictStr] = None
    rooms: Optional[List[SchemaRoomEventsSchemaMazevoEvent]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rooms": [SchemaRoomEventsSchemaMazevoEvent.from_dict(_item) for _item in obj["rooms"]] if obj.get("rooms") is not None else None
        })
        return _obj
