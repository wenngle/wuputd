...
class SchemaAPIResponseSchemaSection(BaseModel):
    """
    SchemaAPIResponseSchemaSection
    """ # noqa: E501
    data: Optional[SchemaSection] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaSection.from_dict(obj["data"]) if obj.get("data") is not None else None,
