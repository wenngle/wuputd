...
class SchemaAPIResponseSchemaProfessor(BaseModel):
    """
    SchemaAPIResponseSchemaProfessor
    """ # noqa: E501
    data: Optional[SchemaProfessor] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaProfessor.from_dict(obj["data"]) if obj.get("data") is not None else None,
