...
class SchemaAPIResponseSchemaCourse(BaseModel):
    """
    SchemaAPIResponseSchemaCourse
    """ # noqa: E501
    data: Optional[SchemaCourse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaCourse.from_dict(obj["data"]) if obj.get("data") is not None else None,
