...
class SchemaAPIResponseSchemaSingleBuildingEventsSchemaSectionWithTime(BaseModel):
    """
    SchemaAPIResponseSchemaSingleBuildingEventsSchemaSectionWithTime
    """ # noqa: E501
    data: Optional[SchemaSingleBuildingEventsSchemaSectionWithTime] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaSingleBuildingEventsSchemaSectionWithTime.from_dict(obj["data"]) if obj.get("data") is not None else None,
