...
class SchemaAPIResponseSchemaObjectInfo(BaseModel):
    """
    SchemaAPIResponseSchemaObjectInfo
    """ # noqa: E501
    data: Optional[SchemaObjectInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaObjectInfo.from_dict(obj["data"]) if obj.get("data") is not None else None,
