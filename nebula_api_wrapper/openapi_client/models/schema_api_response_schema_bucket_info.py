...
class SchemaAPIResponseSchemaBucketInfo(BaseModel):
    """
    SchemaAPIResponseSchemaBucketInfo
    """ # noqa: E501
    data: Optional[SchemaBucketInfo] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": SchemaBucketInfo.from_dict(obj["data"]) if obj.get("data") is not None else None,
