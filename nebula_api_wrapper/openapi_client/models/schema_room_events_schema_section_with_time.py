...
class SchemaRoomEventsSchemaSectionWithTime(BaseModel):
    """
    SchemaRoomEventsSchemaSectionWithTime
    """ # noqa: E501
    events: Optional[List[SchemaSectionWithTime]] = None
    room: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["events", "room"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "events": [SchemaSectionWithTime.from_dict(_item) for _item in obj["events"]] if obj.get("events") is not None else None,
            "room": obj.get("room")
        })
        return _obj
